...
#define STRING_CONFIG_H_AUTHOR "(João Cunha, SKR TMC2209 PINDA BMG E-0.9LDO)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ZARIBO MK3S"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 98, 80, 400, 830 }
